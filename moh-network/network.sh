...
function createOrgs() {
  ...
  infoln "Generating CCP files for Pharmacy and Manufacturer"
...
# call the script to create the channel, join the peers of pharmacy and manufacturer,
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.moh.gov.om docker_peer0.pharmacy.moh.gov.om docker_peer0.manufacturer.moh.gov.om
